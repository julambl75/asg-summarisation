...
In practice, this involves using \textbf{Pattern}\footnote{\label{footnote:pattern}Pattern is a module that is able to perform POS tagging, verb conjugation and noun singularisation, among others: \url{https://www.clips.uantwerpen.be/pages/pattern-en}} to try and find a lexical field to which both words pertain.
...
The result of running the \textit{simplification} transformations on the story of Peter Little is illustrated below in Figure \ref{fig:simplification_example}.
