...
In practice, this involves gathering all of the story-specific leaf nodes and learned \textit{actions} from \textsc{SumASG\textsubscript{1}}, adding these to our general grammar, and then using a set of summary generation rules to create summary sentences.
