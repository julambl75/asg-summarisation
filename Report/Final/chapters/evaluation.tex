...
%- evaluation (robustness): try perturbation that would make NN fail but SumASG* work (totally normal, show our system robust, NN probably less consistent than SumASG*)
%- evaluation (validity): try gibberish with NN and SumASG*
