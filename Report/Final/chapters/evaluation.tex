...
\begin{subfigure}{\textwidth}
\begin{displayquote}
The publication printed a lightning \underline{and} a movement. The publication printed the stereotype.
\end{displayquote}
\caption{Summary}
\end{subfigure}
...
Validation perplexity & 16.73   & 2.07   & 2.15    & 2.23    & 2.36    \\ \bottomrule
\end{tabular}
...
\begin{subfigure}{\textwidth}
\begin{displayquote}
A new approach attacked the \underline{lesson} and the \underline{league}. A new approach attacked the \underline{couple}.
\end{displayquote}
...
\begin{subfigure}{\textwidth}
\begin{displayquote}
A new approach attacked the \underline{lesson} and the \underline{counseling}. A new approach attacked the \underline{league}.
\end{displayquote}
