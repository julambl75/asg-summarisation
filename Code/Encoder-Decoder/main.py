...
if __name__ == '__main__':
    ...
    encoder = EncoderRNN(lang.n_words, HIDDEN_SIZE, num_layers=NUM_LAYERS).to(DEVICE)
    attn_decoder = AttnDecoderRNN(lang.n_words, HIDDEN_SIZE, seq_length, dropout_p=0.1, num_layers=NUM_LAYERS).to(DEVICE)
